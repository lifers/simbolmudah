...
windows_core::imp::define_interface!(
    ...
    0xbae4792d_e30b_5365_9ad4_c47f52a6ed14
);
...
impl KeyboardTranslator {
    ...
    where
        P0: windows_core::Param<windows::Foundation::EventHandler<windows_core::HSTRING>>,
    {
        let this = self;
        unsafe {
...
pub trait IKeyboardTranslator_Impl: Sized {
    ...
    fn OnTranslated(
        &self,
        handler: Option<&windows::Foundation::EventHandler<windows_core::HSTRING>>,
    ) -> windows_core::Result<windows::Foundation::EventRegistrationToken>;
